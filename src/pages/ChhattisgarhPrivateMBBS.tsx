...
import { GraduationCap, MapPin, IndianRupee, Search, Info, Calendar, Users } from "lucide-react";
...
const feeData = [
  { id: 1, name: "Shri Balaji Institute of Medical Science, Raipur", year: "2021", intake: "150", fees: "6,45,155" },
  { id: 2, name: "Shankaracharya Medical College, Bhilai", year: "2016", intake: "150", fees: "6,45,156" },
  { id: 3, name: "Chandulal Chandrakar Memorial Medical College, Durg", year: "2013", intake: "150", fees: "5,18,500" },
  { id: 4, name: "Raipur Institute of Medical Sciences, Raipur", year: "2012", intake: "150", fees: "6,00,156" },
];

export default function ChhattisgarhPrivateMBBS() {
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-light-blue/10 border border-brand-light-blue/20 text-brand-light-blue font-bold text-sm mb-6 uppercase tracking-wider">
                <MapPin size={16} />
                <span>Chhattisgarh Admissions 2026</span>
              </div>
              ...
              <p className="text-lg text-white/70 max-w-2xl mx-auto">
                Detailed tuition fee, establishment year, and intake capacity for private medical colleges in Chhattisgarh.
              </p>
            </motion.div>
          </div>
        </section>
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-100">
                      ...
                      <th className="p-6 font-bold text-brand-navy uppercase tracking-wider text-sm">Est. Year</th>
                      <th className="p-6 font-bold text-brand-navy uppercase tracking-wider text-sm">Intake</th>
                      ...
                      >
                        ...
                        <td className="p-6">
                          <div className="flex items-center gap-1.5 text-gray-600">
                            <Calendar size={14} className="text-brand-light-blue" />
                            <span>{college.year}</span>
                          </div>
                        </td>
                        <td className="p-6">
                          <div className="flex items-center gap-1.5 text-gray-600">
                            <Users size={14} className="text-brand-light-blue" />
                            <span>{college.intake} Seats</span>
                          </div>
                        </td>
